                ...
                <div className="hidden lg:flex space-x-6 items-center">
                    ...
                    {!user ? (
                        <>
                            ...
                            <Link to="/signup" className={getLinkClassName('/signup')}>Signup</Link>
                        </>
                    ) : (
                        <>
                            <span className="p-3 rounded-lg bg-gray-800 text-white font-semibold cursor-default">Welcome, {user.username}</span>
